    ...
    <section id="contacts" className="body leading-6 bg-black">
      ...
      <div className="contact-body max-w-[1320px] my-0 mx-auto py-4 px-0">
        <div className="contact-info my-4 mx-0 text-center py-4 px-0">
          <div className="a my-3 mx-0 p-4 flex flex-col items-center">
            <div className="flex items-center justify-center">
              <span className="text-yellow-500 text-3xl pb-4">
                <FaMapPin />
              </span>
            </div>
            <span className="block text-yellow-500">Address</span>
            <span className="text block text-yellow-500 text-sm font-light opacity-90 pt-2">
        ...
        <div className="contact-form py-8 px-0 border-t-2 border-yellow-500">
          <form action="" className="pb-4">
            ...
            <input
              type="submit"
              className="send-btn text-xs font-semibold uppercase text-black bg-yellow-500 border-none rounded-md py-3 px-6 cursor-pointer transition-all duration-300 ease-in hover:opacity-90 hover:font-bold hover:text-white"
              value="send message"
            />
          </form>

          <div className="my-0 mx-9 text-center justify-center">
            <img
              src={zhy}
              alt="zhyrille logo"
      ...
      <div className="map p-5 bg-yellow-500 shadow-neutral-950 flex items-center justify-center py-4 px-0">
        <iframe
          ...
          className="a border-none w-[98%] h-[384px]"
          allowFullScreen=""
          loading="lazy"
      ...
      <div className="contact-footer py-8 px-0 bg-black">
        <div className="social-links flex justify-center">
          <a
            href="#"
            className="text-yellow-500 no-underline w-10 h-10 border-2 border-yellow-500 rounded-[50%] flex justify-center items-center my-1 mx-3 transition-all duration-300 ease-in hover:text-white hover:border-white"
          >
            <FaFacebookSquare />
          </a>
          <a
        ...
        <h3 className="text-yellow-500 text-xs mt-4 text-center">
