  ...
  return (
    <div>
      ...
      <TERipple rippleColor="white">
        <button
          type="button"
          className="inline-block rounded bg-orange-100 px-6 pb-2 pt-2.5 text-xs font-semibold capitalize leading-normal text-black transition duration-150 ease-in hover:translate-x-3 hover:border-2 hover:border-solid hover:border-orange-100 hover:bg-transparent hover:text-orange-100"
        ...
        <TEModalDialog size="fullscreen">
          <TEModalContent>
            <TEModalHeader>
              ...
              <button
                type="button"
                className="box-content rounded-none border-none hover:no-underline hover:opacity-75 focus:opacity-100 focus:shadow-none focus:outline-none text-black"
            ...
            {/* <!--Modal body--> */}
            <TEModalBody>
              <p className="px-10 text-center leading-[3rem] text-black">
